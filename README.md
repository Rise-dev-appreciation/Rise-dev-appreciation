# RISE RISC-V Developers Appreciation Program
...
The Program is dedicated exclusively to “Open Source Software” (under an open source software license recognized by the Open Source Initiative). Commercial projects are outside the scope of this program. RISE does not claim ownership rights to your Submission. 
...
The more detailed and clear your submission, the faster and more efficiently RISE can process your request for Program recognition. 
...
The RISE Project will determine which contributions to recognize. The goal is to ensure that this process remains as transparent as possible. As this is a Program with a limited budget and timeframe, we will evaluate and incorporate feedback to facilitate learning and adapt for future variations of the program’s implementation. 
...
RISE will not tolerate any abuse of the program. If any project or community encounters issues related to the Program, please contact info@riseproject.dev for resolution. 
...
RISE may publicly recognize developers who have been received recognition under the Program. RISE, at its discretion, may recognize your contribution on a website, blog and social media.


# Terms

* RISE Appreciation Program is for individual contributor's self contributions (aka, not "representing a team" for example)
* RISE reserves the right to change or terminate this Program at any time. Any Submission under the Program is subject to the program details and terms available at that time. 
* Do not undertake any contribution or work with an expectation of a recognition payment for a future Submission. This is a Program with a limited budget for reward payments. Once the budget has been exhausted, RISE will not make any additional recognition payments under this Program. Consequently, some qualifying Submissions may receive reduced recognition payments or no recognition payments at all. Therefore, it is possible that your Submission could qualify for a recognition payment, yet no recognition payment will be issued. RISE is not responsible for Submissions that we do not receive for any reason.
* RISE also reserves the right to refuse payment at its sole discretion if it believes a submission undermines the spirit of this Program or if making the recognition payment would be illegal. 
